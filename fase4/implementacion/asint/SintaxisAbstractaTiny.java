...
public class SintaxisAbstractaTiny {
    ...
    private static abstract class ExpBin extends Exp {
  	...
  	public static class Exp_true extends Exp {
	    ...
	    public int prioridad() {return 7;}
        public void imprime() {
        	print_info("<true>", leeFila(), leeCol());
        }
        public void procesa(Procesamiento p) {
        	p.procesa(this);
        }
  	...
  	public static class Exp_false extends Exp {
	    ...
	    public int prioridad() {return 7;}
        public void imprime() {
        	print_info("<false>", leeFila(), leeCol());
        }
        public void procesa(Procesamiento p) {
        	p.procesa(this);
        }
  	...
  	public static class Exp_null extends Exp {
	    ...
	    public int prioridad() {return 7;}
        public void imprime() {
        	print_info("<null>", leeFila(), leeCol());
        }
        public void procesa(Procesamiento p) {
        	p.procesa(this);
        }
