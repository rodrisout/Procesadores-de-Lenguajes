...
esta práctica, \textit{Tiny}, contamos con 3 palabras reservadas, utilizadas para definir el tipo de las variables. Tendremos pues,
...
5 palabras reservadas para los operadores lógicos and, or, not, true y false, 1 palabra reservada para hacer referencia a la nada, 1 palabra reservada
