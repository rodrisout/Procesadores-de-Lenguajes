...
esta práctica, \textit{Tiny (0)}, contamos con 8 palabras reservadas, 3 de ellas utilizadas para definir el tipo de las variables.
...
de éstas tendremos 5 palabras utilizadas para las operaciones lógicas. Las palabras son las definidas a continuación, contando cada con
una clase léxica.
