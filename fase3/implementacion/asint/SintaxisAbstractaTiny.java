...
public class SintaxisAbstractaTiny {
    ...
    public static class Si_refparam_f extends ParamF {
        ...
        public void imprime() {
            this.tipo.imprime();
            println("&");
            println_info(id, this.leeFila(), this.leeCol());
        }
        // VISITANTE
    }
    ...
    public static class Tipo_array extends Tipo {
        ...
        public void imprime() {
            ...
            println("[");
            println(litEntero);
            println_info("]", this.leeFila(), this.leeCol());
        }
        // VISITANTE
    }
    ...
    public static class Exp_asig extends ExpBin {
        ...
        public void imprime() {
            imprimeExpBin(opnd0, "=", opnd1, 1, 0, this.leeFila(), this.leeCol());
        }
    }
    ...
    public static class Exp_reg extends Exp {
        ...
        public void imprime() {
            ...
            println(".");
            println_info(this.id, this.leeFila(), this.leeCol());
        }
        // VISITANTE
    }
    ...
    private static void println_info(String s, int fila, int col) {
        System.out.println(s + "$f:" + fila + ",c:" + col + "$");
    }

    private static void imprimeExpBin(Exp op0, String op, Exp op1, int np0, int np1, int fil, int col) {
        imprimeOpnd(op0, np0);
        println_info(op, fil, col);
        imprimeOpnd(op1, np1);
    }
